...
<cfif isdefined("form.fieldnames")>
	...
	<cfquery name="add_project" datasource="scooby_doo">
		insert into project_details (name, description, originally_assigned_to, currently_assigned_to, assigned_by, priority, due_date, group_id)
		values ('#form.name#','#local_description#',#local_assigned_to#,#local_assigned_to#,#local_assigned_by#,#local_priority#,'#form.due_date#',#local_group_id#)
	</cfquery>
</cfif>
<html>
<head>
<title>Scooby Doo - Bug Tracking</title>
<style>
.shakeimage{
position:relative
}
...
<tr valign=top>
	...
	<tr valign=top>
		...
		<font face="arial,helvetica,sans-serif,verdana" size=-1><b>Bug Tracking</b></font>
		</td>
	</tr>
	</table>
	</cfoutput>
	...
	<cfoutput query="groups">
		...
		<cfquery name="projects" datasource="scooby_doo">
			select a.project_id, a.name, a.priority, a.start_date, a.due_date, a.group_id, a.status, b.first, b.last
			from project_details as a join users b on a.currently_assigned_to = b.user_id
		...
		<cfif projects.recordcount gt 0>
			...
			<tr bgcolor="7A4034">
				...
				<td colspan=4 align=left><font face="arial,helvetica,sans-serif,verdana" color="white" size=-1><b>#description#</b></font></td>
			</tr>
			<tr bgcolor="BC7F00">
				<th><font face="arial,helvetica,sans-serif,verdana" size=-1 color=white>Priority</font></th>
				<th><font face="arial,helvetica,sans-serif,verdana" size=-1 color=white>AssignedTo</font></th>
			...
			<cfloop query="projects">
				<tr bgcolor="white" onclick="self.location.href='project_details.cfm?project_id=#projects.project_id#&user_id=#local_userid#';" onMouseOver="this.bgColor = '7A4034';this.style.color='white';this.style.cursor='hand';" onMouseOut ="this.bgColor = 'FFFFFF';this.style.color='black';" bgcolor="FFFFFF">
					...
					<td><font face="arial,helvetica,sans-serif,verdana" size=-1>#projects.first# #projects.last#</font></td>
	...
	<cfoutput>
		...
		<table width=82% cellspacing=0 cellpadding=2 border=1 bordercolor="7A4034">
		<tr bgcolor="7A4034">
			<td colspan=2><font face="arial,helvetica,sans-serif,verdana" color="white"><b>Add new bugs to the Bug Tracking</b></font></td>
		</tr>
		<tr valign=top>
			...
			<cfloop query="all_groups">
				<cfif all_groups.group_id eq 1>
					<option selected value=#all_groups.group_id#>#all_groups.name#</option>
				<cfelse>
